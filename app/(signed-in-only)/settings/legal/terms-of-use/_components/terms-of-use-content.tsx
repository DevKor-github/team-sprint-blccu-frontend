const TERMS_OF_USE = [
  {
    title: '제 1조 목적',
    contents: [
      '본 약관은 회원(본 약관에 동의한 자를 말하며 이하 "회원"이라고 합니다)이 블꾸(이하 "회사"라고 합니다)가 제공하는 서비스를 이용함에 있어 회사와 회원의 권리 의무 및 책임사항을 규정함을 목적으로 합니다.',
    ],
  },
  {
    title: '제 2조 정의',
  ...
  {
    title: '부칙 (2024.8.1)',
    contents: ['본 약관은 2024년 8월 1일부터 적용됩니다.'],
  },
] as const;
